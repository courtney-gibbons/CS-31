...
int main()
{
    ...
    cout << "How many Electoral College electors are there? " //compile error #2: missing semicolon
    cin >> totalVoters;
    ...
    pctRepub = ( 100.0 * republicanVotes ) / totalVoters; //compile error #3: not assigning a type to variable
...
#comment //compule error #4: forgetting that this is not python and inserting a comment with a hashtag
