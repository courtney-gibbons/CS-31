...
namespace cs31
{
    ...
    // called to identify the game ended tied - DONE
    ...
    // called to identify the Human won the game - DONE
    // adjust mHumanWon, mComputerWon and mGameOver appropriately
    ...
    // called to identify the Computer won the game - DONE
    // adjust mHumanWon, mComputerWon and mGameOver appropriately
    ...
    // is the game over and has the Human Player already won? - DONE
    ...
    // is the game over and has the Computer Player already won - DONE
